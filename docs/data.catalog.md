...
Overview
The Gold Layer is the business-level data representation, structured to support analytical and reporting use cases. It consists of dimesion tables and fact tables for specific business metrics.
...
| birthdate	       |  DATE	        |   The date of birth of the customer, formatted as YYYY-MM-DD (e.g., 1982-12-27).                          |
...
| sales	          |  INT          | 	The total monetary values of the sale for the line item, in whole currency units (e.g., 25).                |
